        ...
        while True:
            try:
                ...
                if check_repeat[0] >= 1:
                    ...
                    for rowe in range(len(server_data["new_for_client"])):
                        for celle in range(len(server_data["new_for_client"][rowe])):
                            list_grid[rowe][celle] = server_data["new_for_client"][rowe][celle]
