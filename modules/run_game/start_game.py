...
from ..classes.class_music import VolumeDownButton

# Добавляем кнопку уменьшения громкости
volume_down_button = VolumeDownButton(x=1150, y=20, width=50, height=50, font=pygame.font.Font(None, 36))
...
def main_window():
    ...
    while run_game:
        ...
        volume_down_button.draw(screen=main_screen)
        ...
        for event in pygame.event.get():
            ...
            current_volume = volume_down_button.handle_event(event, pygame.mixer.music.get_volume())
