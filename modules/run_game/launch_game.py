...
def start_game():
    ...
    while run_game:
        ...
        #функція max робить так що текстове поле ніколи не буде меньшим за 100 пікселів , але якщо текст буде стпноаитися більшим то текстове поле буде розтягуватись
