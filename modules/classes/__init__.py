...
from .class_input_text import input_nick , input_ip_adress , input_port, input_password
from .class_text import Font
from .class_ship import list_ships 
from .class_click import *
from .class_music import music_load_main , music_load_waiting ,fight_music, victory_music, lose_music
