                ...
                if check_data[0] == "enemy_matrix":
                    ...
                    try:
                        ...
                        for data_enemy in check_data:
                            ...
                            # Если модификатор которы мы получили равняется огненной ракете
                            ...
                            # Если модификатор которы мы получили равняется обычной ракете
                                ...
                                for data_enemy in range(1, len(check_data) - 1, 2): 
                                    if list_grid[int(check_data[1])][int(check_data[2])] in [1, 2, 3, 4, 7]:
                                        ...
                                        if server_module.list_player_role[0] == "server_player":
                                            ...
                                            server_module.turn[0] = "client_turn"
                            # Если модификатор которы мы получили равняется авто ракете
                                ...
                                if count_hit == 0:
                                    ...
                                    if server_module.list_player_role[0] == "server_player":
                                        ...
                                        server_module.turn[0] = "server_turn"
                                server_module.check_time[0] = 0
                            # Если модификатор которы мы получили равняется 3 на 3  ракете
                        ...
                        continue
                    # Если модификатор которы мы получили равняется рандомным 3 атакам ракете
                    if check_data[0] == 'random_hits':
                        ...
                        if count_hit == 0:
                            ...
                            if server_module.list_player_role[0] == "server_player":
                                ...
                                server_module.turn[0] = "server_turn"
                    # Если модификатор которы мы получили равняется восстановление части корабля
                    ...
                    # Если модификатор которы мы получили равняется пополнению в копилку 
